...
/*
  Write a function called unique that takes in an array and a callback function.
...
// CODE HERE
each(names, callback = (item, index) => console.log(`The item at index ${index} is ${item}.`))
